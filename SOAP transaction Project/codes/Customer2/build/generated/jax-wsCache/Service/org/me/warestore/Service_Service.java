 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://WareStore.me.org/", wsdlLocation = "http://localhost:8080/Warehouse/Service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://WareStore.me.org/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Warehouse/Service?wsdl");
    ...
    public org.me.warestore.Service getServicePort() {
        return super.getPort(new QName("http://WareStore.me.org/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public org.me.warestore.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WareStore.me.org/", "ServicePort"), Service.class, features);
    }
